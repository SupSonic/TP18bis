...
/**
 * 
 * Créer un programme permettant de jouer au poker contre une ia.
 * 
 ...
 *  
 * Les participants d'une partie pourront aller de 2 à 4 joueurs 
 * chaque joueur possédera un montant d'argent à miser, si un joueur n'a plus d'argent il est éliminé 
 * 
 ...
 * 		- jeu
 * 
 * 	Le jeu s'arrêtera quand le joueur humain quittera la table ou n'aura plus d'argent ou qu'il sera le seul joueur à table.
 * 
